...
<body>
    ...
    <section class="blog-area area-padding">
        <div class="container">
            ...
            <div class="row">
            <?php
                $informasis = App\Klinik::where('jenis', 'puskesmas')->get();
            ?>
...
</html><?php /**PATH C:\xampp\htdocs\pi-baru\resources\views/frontend/puskesmas.blade.php ENDPATH**/ ?>