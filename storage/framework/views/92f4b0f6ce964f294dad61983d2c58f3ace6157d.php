                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo e(route('tarian')); ?>">
                                            <?php echo e($data->provinsi); ?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                style="background-image: url('<?php echo e(asset('front/img/tarian/slides/slide1.jpg')); ?>')">
            </div>
            <!-- Slide Two - Set the background image for this slide in the line below -->
            <div class="carousel-item"
                style="background-image: url('<?php echo e(asset('front/img/tarian/slides/slide2.jpg')); ?>')">
            </div>
            <!-- Slide Three - Set the background image for this slide in the line below -->
            <div class="carousel-item"
                style="background-image: url('<?php echo e(asset('front/img/tarian/slides/slide3.jpg')); ?>')">
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="<?php echo e(asset('foto_tarian/'.$data->foto)); ?>" alt="">
                        </div>
                        <div class="short_details">

                            <div class="meta-top d-flex">
                                <a><?php echo e($data->provinsi); ?></a>
                            </div>

                            <a class="d-block" href="<?php echo e(url('frontend/show/'.$data->id_tarian)); ?>">
                                <h4>
...
</html><?php /**PATH C:\xampp7\htdocs\viharna\resources\views/frontend/beranda.blade.php ENDPATH**/ ?>