                ...
                <div class="col-md-12 text-center posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid rounded" alt="" src="<?php echo e(asset('foto_tarian/'.$data->foto)); ?>">
                        </div>
                        <div class="blog_details">
                            ...
                            <ul class="blog-info-link mt-3 mb-4">
                                <li><a href="#"><i class="fas fa-map-marked-alt"></i><?php echo e($data->provinsi); ?></a></li>
                            </ul>
                        ...
                        <iframe width="560" height="315" src="<?php echo e($data->video); ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
...
</html><?php /**PATH /storage/ssd2/352/9577352/resources/views/frontend/show.blade.php ENDPATH**/ ?>