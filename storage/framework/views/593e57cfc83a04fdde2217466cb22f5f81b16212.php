...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('front')); ?>/img/favicon1.png">
        ...
        <div class="top_menu row m0">
            <div class="container">
                <div class="float-left">
                    <a class="dn_btn" href="mailto:nabilavirna18@gmail.com"><i class="ti-email"></i>nabilavirna18@gmail.com</a>
                </div>
                <div class="float-right">
                    <ul class="list header_social">
                        <li><a href="https://www.twitter.com"><i class="ti-twitter-alt"></i></a></li>
                        <li><a href="https://www.instagram.com/virnabilaa?igshid=6m3xa4mjzzwf"><i class="ti-instagram"></i></a></li>
                    </ul>	
                </div>
            </div>	
        </div>	
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><span><h1>Traditional Dance</h1></span></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Province</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('klinikFrontend')); ?>">Jawa Barat</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('puskesmasFrontend')); ?>">Jawa Timur</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('klinikFrontend')); ?>">Jawa Tengah</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('puskesmasFrontend')); ?>">DKI Jakarta</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('klinikFrontend')); ?>">Jawa Barat</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('puskesmasFrontend')); ?>">Jawa Timur</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('klinikFrontend')); ?>">Jawa Barat</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('puskesmasFrontend')); ?>">Jawa Timur</a></li>
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('contactFrontend')); ?>">Traditional Dance A to Z</a></li> 
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('contactFrontend')); ?>">About Me</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
    ...
    <footer class="footer-area area-padding-top">
        ...
        <div class="row footer-bottom d-flex justify-content-between">
            <p class="col-lg-8 col-sm-12 footer-text m-0">
                &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by <a href="<?php echo e(route('home')); ?>">Tradisional Dance</a>.</strong>
            </p>
            <div class="col-lg-4 col-sm-12 footer-social">
                <a href="https://www.twitter.com"><i class="fab fa-twitter"></i></a>
                <a href="https://www.instagram.com/virnabilaa?igshid=6m3xa4mjzzwf"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
...
</html><?php /**PATH C:\xampp7\htdocs\pi-baru\resources\views/welcome.blade.php ENDPATH**/ ?>