                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{route('tarian')}}">Traditional Dance A to
                                    Z</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Jawa Barat.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">
                            <a class="d-block" href="{{ url('frontend/shows/Jawa Barat') }}">
                                <h2>
                                    Jawa Barat
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Jawa Timur.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows2/Jawa Timur') }}">
                                <h2>
                                    Jawa Timur
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Bali.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows3/Bali') }}">
                                <h2>
                                    Bali
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi DI Yogyakarta.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows4/Yogyakarta') }}">
                                <h2>
                                    Yogyakarta
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Kalimantan Timur.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows5/Kalimantan Timur') }}">
                                <h2>
                                    Kalimantan Timur
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Jawa Tengah.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows6/Jawa Tengah') }}">
                                <h2>
                                    Jawa Tengah
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Aceh.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows7/Aceh') }}">
                                <h2>
                                    Aceh
                                </h2>
                            </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('front/img/provinsi/Logo Provinsi Nusa Tenggara Timur.jpeg')}}" alt="">
                        </div>
                        <div class="short_details">

                            <a class="d-block" href="{{ url('frontend/shows8/Nusa Tenggara Timur') }}">
                                <h2>
                                    Nusa Tenggara Timur
                                </h2>
                            </a>
