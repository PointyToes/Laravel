...
<body>
    ...
    <section class="blog-area area-padding">
        <div class="container" style="margin-bottom: 240px;">
            ...
            <div class="row">
                @php
                    $info = App\Tarian::where('provinsi', 'Nusa Tenggara Timur')->get();
                @endphp
                @foreach ($info as $datas)
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('foto_tarian/'.$datas->foto)}}" alt="">
                        </div>
                        <div class="short_details">
                            ...
                            <a class="d-block" href="{{ url('frontend/show/'.$datas->id_tarian) }}">
                                <h4>
                                    {{$datas->nama_tarian}}
                                </h4>
                            </a>
